...
public class AccountDao {
    public static AccountList readAll(APIConfig apiConfig){
        String response = APICaller.callResource(apiConfig, APIResource.ACCOUNT, HttpMethod.GET, null);
    ...
    public static void create(APIConfig apiConfig, Account account) {
        ...
        json = "{ "+ "\"account\": " +json+" " +" }";
        String response = APICaller.callResource(apiConfig, APIResource.ACCOUNT, HttpMethod.POST, json);
