...
public class AccountDao {
    ...
    public static Account read(APIConfig apiConfig, String id) throws APIException {
    ...
    public static List<Account> readAll(APIConfig apiConfig) throws APIException {
    ...
    public static void create(APIConfig apiConfig, Account account) throws APIException {
        ObjectMapper objectMapper = new ObjectMapper();
        String json = null;
        try {
    ...
    public static Account update(APIConfig apiConfig, String id, Map<String, String> map) throws APIException {
        ObjectMapper objectMapper = new ObjectMapper();
        String json = null;
        try {
    ...
    public static void delete(APIConfig apiConfig, String id) throws APIException {
